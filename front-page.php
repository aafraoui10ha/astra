...
<section >
  ...
  <span class="line "></span>
      ...
      <!-- Images in one row -->
      <div class="col-12 d-flex justify-content-center flex-wrap g-5">
        
        <!-- category 1 -->
        <div class="">
          <a href="#" class="text-decoration-none hover-a">
            <img class="category-img-wrapper img-fluid category-img" src="<?php echo get_template_directory_uri(); ?>/assets/img/skin-cleanser-template-about-page-header-img-bg.jpg" alt="">
            <p class="text-center hover-a">haircare</p>
          </a>
        </div>
        ...
        <div class="">
          <a href="#" class="text-decoration-none hover-a">
            <img class="category-img-wrapper img-fluid category-img" src="<?php echo get_template_directory_uri(); ?>/assets/img/skin-cleanser-template-about-page-header-img-bg.jpg" alt="">
            <p class="text-center hover-a">skincare</p>
          </a>
        </div>
...
<section class="py-5">
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-md-8">
        <h2 class="text-uppercase font-weight-bold mb-3">Our Products</h2>
