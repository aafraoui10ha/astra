...
<li <?php wc_product_class('', $product); ?>>
  ...
  $main_image_url = get_the_post_thumbnail_url($product->get_id(), 'full'); // woocommerce_thumbnail
  $attachment_ids = $product->get_gallery_image_ids();
  $hover_image_url = isset($attachment_ids[0]) ? wp_get_attachment_image_url($attachment_ids[0], 'full') : ''; // woocommerce_thumbnail
  ?>
